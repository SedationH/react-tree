...
import { buildNestedTokenDOMs, iterateNestedTokenDOMs, NestedTokenDOM } from './preprocess';
...
class TOC {
  ...
  adaptTreeDataFromNestedTokenDOMs(nestedTokenDOMs: NestedTokenDOM[]): TreeData {
    return iterateNestedTokenDOMs<NodeData>(nestedTokenDOMs, (nestedTokenDOM) => {
