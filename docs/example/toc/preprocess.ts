...
export { extractArticle, extractTokenDOMs, buildNestedTokenDOMs, iterateNestedTokenDOMs };
...
*/
function nestTokenDOMs(nestedTokenDOMs: NestedTokenDOM[], currentNestedTokenDOM: NestedTokenDOM) {
